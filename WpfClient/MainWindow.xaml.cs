...
namespace WpfClient
{
	...
	public partial class MainWindow
	{
		...
		{
			Log("Connecting");
			Log("Ip " + IpAddressServer.Text);
			Log("Port " + PortServer.Text);

			IPAddress destinationAddr = IPAddress.Parse(IpAddressServer.Text);
			...
			socketEventArg.RemoteEndPoint = new IPEndPoint(destinationAddr, int.Parse(PortServer.Text));

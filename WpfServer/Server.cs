...
namespace AsyncSocketServer
{
	...
	class Server
	{
		...
		public void Init()
		{
			...
			_logger.Log("Echo server initialized");
		}
		...
		public void Start(IPEndPoint localEndPoint)
		{
			...
			_logger.Log("Echo server listening...");
		...
		private void ProcessAccept(SocketAsyncEventArgs e)
		{
			...
			_logger.Log("Echo server client connection accepted. There are " + m_numConnectedSockets + " clients connected to the server");
		...
		private void ProcessReceive(SocketAsyncEventArgs e)
		{
			...
			if (e.BytesTransferred > 0 && e.SocketError == SocketError.Success)
			{
				...
				_logger.Log("Echo server has read a total of " + m_totalBytesRead + " bytes");
		...
		private void CloseClientSocket(SocketAsyncEventArgs e)
		{
			...
			_logger.Log("Echo server: A client has been disconnected from the server. There are " + m_numConnectedSockets + " clients connected to the server");
